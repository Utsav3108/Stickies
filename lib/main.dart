  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        // Category provider (will be injected with analytics later)
        ChangeNotifierProvider(
          create: (_) {
            final provider = CategoryProvider();
            provider.setAnalyticsService(analyticsService);
            return provider;
          },
        ),

        // Entry provider with analytics dependency
        ChangeNotifierProvider(
          create: (_) => EntryProvider(analyticsService: analyticsService),
        ),
    ...
    try {
      ...
      if (mounted) {
        ...
        switch (e.code) {
          ...
          case 'notAvailable':
            message =
                'Authentication not available. Please set up a screen lock (PIN/Pattern/Fingerprint) in device settings.';
            break;
          case 'NotEnrolled':
          case 'PasscodeNotSet':
            message =
                'No authentication method found. Please set up device lock in settings.';
            break;
          case 'LockedOut':
          case 'lockedOut':
          ...
          case 'permanentlyLockedOut':
            message =
                'Authentication locked. Please unlock your device and try again.';
            break;
